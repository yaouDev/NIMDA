...
public class EliasPlayer : MonoBehaviour
{
	...
	{
		EliasWrapper.elias_result_codes r = EliasWrapper.elias_start_background_with_action_preset(elias.Handle, preset);
	...
	{
		EliasWrapper.elias_result_codes r = EliasWrapper.elias_start_background_wrapped(elias.Handle, setLevel);
	...
	private void Start()
    {
		elias = new EliasHelper(file, eliasChannelCount, eliasFramesPerBuffer, eliasCachePageCount, eliasCachePageSize);
		if (playOnStart) 
		{
			StartElias ();
		}
