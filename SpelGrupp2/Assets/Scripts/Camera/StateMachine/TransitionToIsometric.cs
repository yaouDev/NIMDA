...
public class TransitionToIsometric : CameraBaseState
{
    ...
    public override void Run() {
	    ...
	    CameraTransform.position = Vector3.Lerp(initialCameraPosition,  centroid + abovePlayer + Quaternion.Euler(topDownViewRotation.x, topDownViewRotation.y, 0.0f) * topDownOffset, easedPercentage);
