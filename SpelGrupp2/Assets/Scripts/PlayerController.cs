...
public class PlayerController : MonoBehaviour {
	...
	[SerializeField] [Range(0.0f, 10.0f)] [Tooltip("Extra force when character is turning the opposite way")]
	private float _turnSpeedModifier = 2.0f; 
	
	[SerializeField] [Range(0.0f, 20.0f)] [Tooltip("Max speed")]
	...
	[SerializeField] [Tooltip("What LayerMask(s) the character should collide with")]
